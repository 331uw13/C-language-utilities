...
int main() {
    ...
    const int document_A_ID = 275821751;
    const int document_B_ID = 57882752;
    const int document_C_ID = 783473434;
    const int document_D_ID = 72851728;
    const int document_E_ID = 8387634;
